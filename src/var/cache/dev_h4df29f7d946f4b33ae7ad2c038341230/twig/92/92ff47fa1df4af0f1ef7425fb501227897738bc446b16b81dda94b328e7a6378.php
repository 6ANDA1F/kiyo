...
class __TwigTemplate_4888878f94069eddd9d843a2161eba87d2a4869e07642b4a50f104d856a2474f extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_toolbar($context, array $blocks = [])
    {
        ...
        // line 5
        echo "        ";
        $context["status_color"] = (((1 === twig_compare(((sw_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "memory", [], "any", false, false, false, 5) / 1024) / 1024), 50))) ? ("yellow") : (""));
        // line 6
        echo "        ";
        ...
        // line 7
        echo sw_escape_filter($this->env, twig_sprintf("%.1f", ((sw_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "memory", [], "any", false, false, false, 7) / 1024) / 1024)), "html", null, true);
        echo "</span>
    ...
    ";
        ...
        echo "        <div class=\"sf-toolbar-info-piece\">
            ...
            <span>";
        // line 14
        echo sw_escape_filter($this->env, twig_sprintf("%.1f", ((sw_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "memory", [], "any", false, false, false, 14) / 1024) / 1024)), "html", null, true);
        echo " MiB</span>
        </div>
        ...
        <div class=\"sf-toolbar-info-piece\">
            ...
            <span>";
        // line 19
        (((0 === twig_compare(sw_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "memoryLimit", [], "any", false, false, false, 19),  -1))) ? (print ("Unlimited")) : (print (sw_escape_filter($this->env, twig_sprintf("%.0f MiB", ((sw_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "memoryLimit", [], "any", false, false, false, 19) / 1024) / 1024)), "html", null, true))));
        echo "</span>
        </div>
    ";
