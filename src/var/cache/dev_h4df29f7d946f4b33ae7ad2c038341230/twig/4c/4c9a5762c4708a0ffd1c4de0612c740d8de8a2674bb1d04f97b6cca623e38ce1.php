...
class __TwigTemplate_cbb1217cde8931906a66695c7e32f1ded9f37fc11aeb2a427f2f7e8b9706a49a extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_page_content_sections_inner($context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable(sw_get_attribute($this->env, $this->source, ($context["cmsPage"] ?? null), "sections", [], "any", false, false, false, 3));
        $context['loop'] = [
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["section"]) {
            // line 4
            echo "            ";
            $context["sectionBgColor"] = sw_get_attribute($this->env, $this->source, $context["section"], "backgroundColor", [], "any", false, false, false, 4);
            // line 5
            echo "            ";
            $context["sectionBgImg"] = $this->extensions['Shopware\Storefront\Framework\Twig\Extension\UrlEncodingTwigFilter']->encodeMediaUrl(sw_get_attribute($this->env, $this->source, $context["section"], "backgroundMedia", [], "any", false, false, false, 5));
            // line 6
            echo "            ";
            $context["sectionBgImgMode"] = sw_get_attribute($this->env, $this->source, $context["section"], "backgroundMediaMode", [], "any", false, false, false, 6);
            // line 7
            echo "
            ";
            // line 8
            $context["sectionClasses"] = [0 => sw_get_attribute($this->env, $this->source, $context["section"], "cssClass", [], "any", false, false, false, 8), 1 => ("pos-" . sw_get_attribute($this->env, $this->source, $context["section"], "position", [], "any", false, false, false, 8)), 2 => ("cms-section-" . sw_get_attribute($this->env, $this->source, $context["section"], "type", [], "any", false, false, false, 8))];
            // line 9
            echo "
            ";
            // line 10
...
";
    ...
    public function block_page_content_section($context, array $blocks = [])
    {
        ...
        if (($context["sectionBgImg"] ?? null)) {
            ...
            echo sw_escape_filter($this->env, sw_get_attribute($this->env, $this->source, ($context["section"] ?? null), "backgroundMediaMode", [], "any", false, false, false, 20), "html", null, true);
            echo ";";
        }
        echo "\">
        ...
        ((function () use ($context, $blocks) {
            ...
            $includeTemplate = $finder->find((("@Storefront/storefront/section/cms-section-" . sw_get_attribute($this->env, $this->source, ($context["section"] ?? null), "type", [], "any", false, false, false, 22)) . ".html.twig"));
