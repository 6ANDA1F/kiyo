...
class __TwigTemplate_67bcbb0ce91e73fe27d269a78fc190b89e951cf74c8878f75f50f821a8de249a extends Template
{
    private $source;
    private $macros = [];
...
if (typeof Sfjs === 'undefined' || typeof Sfjs.loadToolbar === 'undefined') {
    Sfjs = (function() {
        ...
        if (array_key_exists("excluded_ajax_paths", $context)) {
            ...
            // line 312
            echo call_user_func_array($this->env->getFilter('json_encode')->getCallable(), [($context["excluded_ajax_paths"] ?? null)]);
            echo "))) {
                        var method = 'GET';
            ...
            if (window.XMLHttpRequest && XMLHttpRequest.prototype.addEventListener) {
                ...
                XMLHttpRequest.prototype.open = function(method, url, async, user, pass) {
                    ...
                    if (url.slice(0, 1) === '/') {
                        if (0 === url.indexOf('";
            // line 355
            echo sw_escape_filter($this->env, sw_escape_filter($this->env, sw_get_attribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, false, 355), "js"), "html", null, true);
            echo "')) {
                            path = url.slice(";
            // line 356
            echo sw_escape_filter($this->env, twig_length_filter($this->env, sw_get_attribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, false, 356)), "html", null, true);
            echo ");
                        }
                    }
                    else if (0 === url.indexOf('";
            // line 359
            echo sw_escape_filter($this->env, sw_escape_filter($this->env, (sw_get_attribute($this->env, $this->source, ($context["request"] ?? null), "schemeAndHttpHost", [], "any", false, false, false, 359) . sw_get_attribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, false, 359)), "js"), "html", null, true);
            echo "')) {
                        path = url.slice(";
            // line 360
            echo sw_escape_filter($this->env, twig_length_filter($this->env, (sw_get_attribute($this->env, $this->source, ($context["request"] ?? null), "schemeAndHttpHost", [], "any", false, false, false, 360) . sw_get_attribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, false, 360))), "html", null, true);
            echo ");
                    }
        ...
        return {
            ...
            loadToolbar: function(token, newToken) {
                ...
                this.load(
                    ...
                    '";
        // line 540
        echo sw_escape_filter($this->env, sw_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("_wdt", ["token" => "xxxxxx"]), "js"), "html", null, true);
        ...
        // line 621
        echo sw_escape_filter($this->env, sw_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("_profiler_home"), "js"), "html", null, true);
