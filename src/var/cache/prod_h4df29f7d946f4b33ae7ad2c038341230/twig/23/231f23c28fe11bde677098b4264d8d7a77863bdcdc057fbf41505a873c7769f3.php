...
class __TwigTemplate_481b266f5f20455bdde5a9fef3decdf7d4cc51712878c6cc803b0da399b33858 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_element_product_slider_alignment($context, array $blocks = [])
    {
        ...
        // line 45
        echo "            ";
        if (sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["config"] ?? null), "verticalAlign", [], "any", false, false, false, 45), "value", [], "any", false, false, false, 45)) {
            // line 46
            echo "                </div>
            ";
        }
    ...
    public function block_element_image_container($context, array $blocks = [])
    {
        ...
        if (sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["element"] ?? null), "data", [], "any", false, false, false, 12), "media", [], "any", false, false, false, 12), "url", [], "any", false, false, false, 12)) {
            ...
            echo "\"
                                    ";
            // line 14
            if ((sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["element"] ?? null), "translated", [], "any", false, false, false, 14), "config", [], "any", false, false, false, 14), "minHeight", [], "any", false, false, false, 14), "value", [], "any", false, false, false, 14) && (0 === twig_compare(sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["element"] ?? null), "translated", [], "any", false, false, false, 14), "config", [], "any", false, false, false, 14), "displayMode", [], "any", false, false, false, 14), "value", [], "any", false, false, false, 14), "cover")))) {
...
($context["element"] ?? null), "data", [], "any", false, false, false, 19), "media", [], "any", false, false, false, 19), "translated", [], "any", false, false, false, 19), "title", [], "any", false, false, false, 19)) ? (sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["element"] ?? null), "data", [], "any", false, false, false, 19), "media", [], "any", false, false, false, 19), "translated", [], "any", false, false, false, 19), "title", [], "any", false, false, false, 19)) : (""))];
        ...
        echo "
                                        ";
        // line 22
        if (((0 === twig_compare(sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["element"] ?? null), "translated", [], "any", false, false, false, 22), "config", [], "any", false, false, false, 22), "displayMode", [], "any", false, false, false, 22), "value", [], "any", false, false, false, 22), "cover")) || (0 === twig_compare(sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["element"] ?? null), "translated", [], "any", false, false, false, 22), "config", [], "any", false, false, false, 22), "displayMode", [], "any", false, false, false, 22), "value", [], "any", false, false, false, 22), "contain")))) {
            // line 23
            echo "                                            ";
        ...
        })())->display(twig_array_merge($context, ["media" => sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source,         // line 27
($context["element"] ?? null), "data", [], "any", false, false, false, 27), "media", [], "any", false, false, false, 27), "name" => "cms-image-thumbnails"]));
    ...
    {
        return new Source("", "@Storefront/storefront/element/cms-element-image.html.twig", "/var/www/html/vendor/shopware/storefront/Resources/views/storefront/element/cms-element-image.html.twig");
    }
}
