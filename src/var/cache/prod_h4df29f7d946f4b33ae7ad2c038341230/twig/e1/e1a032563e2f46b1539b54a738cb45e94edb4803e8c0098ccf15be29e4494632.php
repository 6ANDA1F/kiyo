...
class __TwigTemplate_769718e3e4aa8c23015e3fba99f06d3ee8f5bf28c35c060fffcc6f620b5472e5 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_layout_header_logo($context, array $blocks = [])
    {
        ...
        echo "                <div class=\"col-12 col-lg-auto header-logo-col\">
                    ";
        // line 10
        $this->loadTemplate("@KiyoTheme/storefront/layout/header/logo.html.twig", "@Storefront/storefront/layout/header/header.html.twig", 10)->display($context);
        // line 11
        echo "                </div>
            ";
    }
    ...
    {
        return new Source("", "@Storefront/storefront/layout/header/header.html.twig", "/var/www/html/vendor/shopware/storefront/Resources/views/storefront/layout/header/header.html.twig");
    }
}
